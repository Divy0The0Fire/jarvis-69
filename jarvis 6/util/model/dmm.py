...
functions = [
    ...
    Fn(
        ...
        description=dedent(
            ...
            Pass the user's query as the input parameter 'query' to get an appropriate response.
            """
        ),
        parameter={"query": "string"}
    ),
...
llm = Cohere(model=COMMAND_R_PLUS, systemPrompt=generateSystemPrompt(functions))
