...
if __name__ == "__main__":
    ...
    llm = Groq(LLAMA_32_90B_VISION_PREVIEW)
    llm2 = Groq(LLAMA_32_90B_VISION_PREVIEW)
    llm3 = Groq(LLAMA_32_90B_VISION_PREVIEW)
    
    llm.run("what is 2+2 reply in 1 char")
    llm2.run("what is 2+3 reply in 1 char")
    llm3.run("what is 2+4 reply in 1 char")
