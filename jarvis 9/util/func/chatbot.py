...
from modules.llm.base import LLM
...
class Chatbot:
    ...
    def run(self, prompt: str, messages: Optional[list] = None) -> str:
        ...
        systemPrompt, imagePrompt = self.systemPrompt.fastpromptWithImages
        ...
        self.llm.messages.extend(imagePrompt)
