...
systemPromptTemplate = Prompt(
    template=[
        ...
        Text(
            "you have to store all the users personal history for chatbot. save all the things that you think are import or can be asked by chatbot. users favorite food, favourite color, favourite movie, people's name and role and all the things. it is important to store it."
        )
    ],
    separator=f"\n{'-'*48}\n"
)
