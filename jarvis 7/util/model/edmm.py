...
systemPromptTemplate = Prompt(
    template=[
        ...
        Text(
            "you have to choose the emotions that chatbot will know to responce the user decide this on the basis of users chat history. Add and remove current system tray emotions accordingly."
        ),
        Function(
            currentEmotions
        ),
