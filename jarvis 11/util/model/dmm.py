...
functions = [
    ...
    Fn(
        ...
        description=dedent(
            ...
            - "What did I say about the new AI model?"
            - "What is the capital of France?"
            - "Hello, how are you?"
            DO NOT ANSWER THE QUESTION BY YOURSELF. CALL THIS FUNCTION.
            """
        ),
    ...
    Fn(
        ...
        description=dedent(
            """
            Use this function for tasks related to music playback.
            'musicPlayerAssistant' is an advanced AI that can:
            - Play, pause, or stop music
            - Skip to the next or previous song
            - Adjust the volume
            - List all downloaded music tracks
            - Get the current status of the music player
            Pass only the task description or problem statement. DO NOT include music player commands in your query.  
            """
        ),
        parameter={"query": "string"}
    ),
