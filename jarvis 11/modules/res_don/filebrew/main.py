...
def filebrewPrompt():
    with open(os.path.join(PROMPTS_DIR, "filebrew.jinja2"), "r") as f:
        return f.read()
...
from nara.llm.base import Role, LLM
...
if __name__ == "__main__":
    ...
    # from modules.llm._groq import LLAMA_32_90B_TEXT_PREVIEW, Groq
